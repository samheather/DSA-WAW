...
public class LevelSelect extends GenericWindow {
	...
	private void drawButtons(GameContainer gameContainer, StateBasedGame game) {
		...
		Image padlock = this.padlockImage;
		...
		// Level 1 Text
		this.drawShadowedText(this.font, level1ImagePos[0]
		...
		// Level 2 Text
		this.drawShadowedText(this.font, level2ImagePos[0]
		...
		// Level 3 Text
		this.drawShadowedText(this.font, level3ImagePos[0]
	...
	public void render(GameContainer gameContainer, StateBasedGame game,
		...
		if (image1Pos != null && image2Pos != null && image3Pos != null) {
			graphics.fillRect(image1Pos[0] - 4, image1Pos[1] - 4, this
					.getLevel1Image().getWidth() + 8, this.getLevel1Image()
					.getHeight() + 8);
			graphics.fillRect(image2Pos[0] - 4, image2Pos[1] - 4, this
					.getLevel2Image().getWidth() + 8, this.getLevel2Image()
					.getHeight() + 8);
			graphics.fillRect(image3Pos[0] - 4, image3Pos[1] - 4, this
