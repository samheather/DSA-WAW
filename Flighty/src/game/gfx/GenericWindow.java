...
public abstract class GenericWindow extends BasicGameState {
	 ...
	 * 
	 * @param font
	 *            the TrueType font to display the text in
	 * @param x
	 *            the x position to display the text at
	 * @param y
	 *            the y position to display the text at
	 * @param text
	 *            the string to display
	 * @param color
	 *            the colour to display the text in
	 */
	protected void drawShadowedText(TrueTypeFont font, int x, int y,
	...
	public void init(GameContainer gameContainer, StateBasedGame game)
		...
		this.font = new TrueTypeFont(this.fontPrimitive.deriveFont(
				Font.CENTER_BASELINE, 20.0f), false);
		this.titleFont = new TrueTypeFont(this.fontPrimitive.deriveFont(
				Font.BOLD, 40.0f), false);
	}
	...
	public void enter(GameContainer gameContainer, StateBasedGame game)
		...
		((AppGameContainer) gameContainer).setDisplayMode(
				WindowManager.WINDOW_WIDTH, WindowManager.WINDOW_HEIGHT, false);
	}
	...
	/**
	 * @param font
	 *            the new normal font derivative
	 */
