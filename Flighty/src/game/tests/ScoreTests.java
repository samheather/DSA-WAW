...
public class ScoreTests {
	...
	public void addScoreTest() {
		...
		// Testing of values
		assertTrue(game.getScore().getScore() == 5
	...
	public void planeLeftAirspaceOrWaitingToTakeoffMinusTests() {
		...
		/*
		 * Testing - Plane left airspace - Current score = 0; - Current
		 * multiplier = 1;
		 */
		...
		/*
		 * Testing - Plane left airspace - Current score = 10; - Current
		 * multiplier = 1;
		 */
		...
		/*
		 * Testing - Plane left airspace - Current score = 30; - Current
		 * multiplier = 2;
		 */
	...
	public void planePilotedPerfectlyMultiplierBonusTests() {
		...
		/*
		 * Testing - plane.getViolationOccurred() = false; - Current multiplier
		 * = 1;
		 */
		...
		/*
		 * Testing - plane.getViolationOccurred() = true; - Current multiplier =
		 * 1;
		 */
	...
	public void planeCollisionWarningMultAndScorePenaltiesTests() {
		...
		/*
		 * Testing - Current score = 5; - Current multiplier = 1;
		 */
		...
		/*
		 * Testing - Current score = 5; - Current multiplier = 2;
		 */
		...
		/*
		 * Testing - Current score = 15; - Current multiplier = 2;
		 */
		...
		/*
		 * Testing - Current score = 0; - Current multiplier = 1;
		 */
