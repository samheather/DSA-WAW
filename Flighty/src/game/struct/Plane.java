...
public class Plane implements java.io.Serializable {
			...
			double bearing, Game currentGame, long uniqueNetworkObjectId)
	{
		...
		{	// Forces every new plane to head towards its first waypoint
	...
	/**
	 * Method to take off. 
	 * Plane is assigned a velocity upon taking off, and is deselected so the user can't change the course
	 * while the plane is in the process of taking off
	 */
	public void takeOff()
	{
	...
	/**
	 * Method to update altitude
	 * First it checks whether the plane is landing, in which case the altitude decreases according to 
	 * the landing descent rate
	 * Otherwise, the altitude changes towards the desired altitude at a constant speed, incrementally.
	 */
